========================================================================
    STATIC LIBRARY : KofPackStatic Project Overview
========================================================================

AppWizard has created this KofPackStatic library project for you.

This file contains a summary of what you will find in each of the files that
make up your KofPackStatic application.


KofPackStatic.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    named KofPackStatic.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "KofPackStatic.rc" and a "KofPackStatic.h" that
